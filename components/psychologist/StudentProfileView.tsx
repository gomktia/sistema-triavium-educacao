...
const DownloadCrisisReportButton = dynamic(
    () => import('@/components/reports/DownloadCrisisReportButton').then((mod) => mod.DownloadCrisisReportButton),
    {
        loading: () => <div className="animate-pulse h-10 bg-slate-200 rounded-lg" />,
        ssr: false,
    }
);
