...
import { Building2, ImageIcon, Save, CheckCircle2, Globe, FileText, Mail, Phone, MapPin } from 'lucide-react';
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-10 animate-in fade-in duration-500">
            <div>
                ...
                <p className="text-slate-500 mt-1.5 text-sm">Gerencie a identidade visual, domínio e dados da sua instituição.</p>
            </div>
                ...
                <Card className="border-none shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden">
                    <CardHeader className="bg-slate-50/50 border-b border-slate-100/50 p-8">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <CardTitle className="text-xl font-black text-slate-900 tracking-tight">Domínio e Acesso</CardTitle>
                                <CardDescription className="text-sm">Configurações de slug e domínio personalizado.</CardDescription>
                            </div>
                        </div>
                    </CardHeader>
                    <CardContent className="p-8 space-y-7">
                        <div className="space-y-2.5">
                            <Label htmlFor="slug" className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest ml-1">
                                Slug (somente leitura)
                            </Label>
                            <div className="relative group">
                                <Globe className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-300" size={18} strokeWidth={1.5} />
                                <Input
                                    id="slug"
                                    value={tenant?.slug || ''}
                                    disabled
                                    className="h-14 pl-12 rounded-2xl border-slate-200 bg-slate-50 text-slate-400 font-medium cursor-not-allowed"
                                />
                            </div>
                        </div>

                        <div className="space-y-2.5">
                            <Label htmlFor="customDomain" className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest ml-1">
                                Domínio Personalizado
                            </Label>
                            <div className="relative group">
                                <Globe className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-600 transition-colors" size={18} strokeWidth={1.5} />
                                <Input
                                    id="customDomain"
                                    value={customDomain}
                                    onChange={(e) => setCustomDomain(e.target.value)}
                                    placeholder="escola.meudominio.com.br"
                                    className="h-14 pl-12 rounded-2xl border-slate-200 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-medium"
                                />
                            </div>
                        </div>
                ...
                <Card className="border-none shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden">
                    <CardHeader className="bg-slate-50/50 border-b border-slate-100/50 p-8">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <CardTitle className="text-xl font-black text-slate-900 tracking-tight">Dados Institucionais</CardTitle>
                                <CardDescription className="text-sm">Informações de contato e endereço da instituição.</CardDescription>
                            </div>
                        </div>
                    </CardHeader>
                    <CardContent className="p-8 space-y-7">
                        <div className="space-y-2.5">
                            <Label htmlFor="cnpj" className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest ml-1">
                                CNPJ
                            </Label>
                            <div className="relative group">
                                <FileText className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-600 transition-colors" size={18} strokeWidth={1.5} />
                                <Input
                                    id="cnpj"
                                    value={cnpj}
                        ...
                        <div className="space-y-2.5">
                            ...
                            <div className="relative group">
                                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-600 transition-colors" size={18} strokeWidth={1.5} />
                                <Input
                                    id="email"
                                    type="email"
                                    value={email}
                        ...
                        <div className="space-y-2.5">
                            <Label htmlFor="phone" className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest ml-1">
                                Telefone
                            </Label>
                            <div className="relative group">
                                <Phone className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-600 transition-colors" size={18} strokeWidth={1.5} />
                                <Input
                                    id="phone"
                                    value={phone}
                        ...
                        <div className="space-y-2.5">
                            <Label htmlFor="address" className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest ml-1">
                                Endereço
                            </Label>
                            <div className="relative group">
                                <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-600 transition-colors" size={18} strokeWidth={1.5} />
                                <Input
                                    id="address"
                                    value={address}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2.5">
                                <Label htmlFor="city" className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest ml-1">
                                    Cidade
                                </Label>
                                <div className="relative group">
                                    <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-600 transition-colors" size={18} strokeWidth={1.5} />
                            ...
                            <div className="space-y-2.5">
                                <Label htmlFor="state" className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest ml-1">
                                    Estado
                                </Label>
                                <Input
                                    id="state"
                                    ...
                                    placeholder="SP"
                                    maxLength={2}
                                    className="h-14 rounded-2xl border-slate-200 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-medium text-center uppercase"
                                />
                            </div>
                        </div>
                    </CardContent>
