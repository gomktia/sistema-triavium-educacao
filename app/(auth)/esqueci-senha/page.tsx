                ...
                <div className="bg-white/70 backdrop-blur-2xl rounded-[2.5rem] border border-white shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] overflow-hidden">
                    <div className="p-8 sm:p-12">
                        <div className="mb-10 text-center">
                            <Link href="/login" className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-600 to-violet-700 text-white shadow-xl shadow-indigo-100 mb-6 hover:scale-110 transition-transform duration-500">
                        ...
                        {sent ? (
                            <div className="space-y-6">
                                ...
                                <Link href="/login" className="flex items-center justify-center gap-2 text-sm font-bold text-indigo-600 hover:text-indigo-700">
                                    <ArrowLeft size={16} />
                                    Voltar para login
                                </Link>
                            </div>
